...
import com.cricketcraft.chisel.client.model.ModelAutoChisel;
...
public class RenderAutoChisel extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float scale) {
		...
		/*
		 * EntityItem chisel = getGhostItem(autoChisel.getWorldObj(), new
		 * ItemStack(ModItems.chisel));
		 * 
		 * if(chisel != null){ GL11.glPushMatrix(); GL11.glTranslated(x + 1.5, y
		 * + 1.5, z + 1.5); GL11.glScaled(1, 1, 1);
