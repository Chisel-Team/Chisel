...
public class Crafting {
	...
	public static void init() {
		...
		if (Configurations.featureEnabled("factory"))
			GameRegistry.addRecipe(new ItemStack(ModBlocks.factory, Configurations.factoryBlockAmount, 0), new Object[] { "*X*", "X X", "*X*", '*', new ItemStack(Blocks.stone, 1), 'X',
					new ItemStack(Items.iron_ingot, 1) });
		if (Configurations.featureEnabled("voidstone")) {
			GameRegistry.addRecipe(new ItemStack(ModBlocks.voidstone, 8, 0), new Object[] { "oxo", "xyx", "oxo", 'x', new ItemStack(Blocks.stone, 1), 'y', new ItemStack(Items.ender_pearl, 1), 'o',
					new ItemStack(Blocks.obsidian, 1) });
			GameRegistry.addRecipe(new ItemStack(ModBlocks.voidstone2, 8, 0), new Object[] { "oxo", "xyx", "oxo", 'x', new ItemStack(Blocks.stone, 1), 'y', new ItemStack(Items.ender_eye, 1), 'o',
					new ItemStack(Blocks.obsidian, 1) });
		}
		...
		if (Configurations.chiselRecipe) {
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.chisel, 1, 1), new Object[] { " YY", " YY", "x  ", 'x', "stickWood", 'Y', "ingotIron" }));
		} else {
		...
		if (Configurations.featureEnabled("smashingrock"))
			GameRegistry.addShapelessRecipe(new ItemStack(ModItems.smashingRock, 16), new Object[] { new ItemStack(Items.stone_pickaxe), new ItemStack(Items.glass_bottle, 1),
		...
		for (int i = 0; i < 16; i++) {
			...
			if (Configurations.featureEnabled("woolenClay"))
				GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModBlocks.woolenClay, 2, i), new Object[] { "blockWool" + sGNames[i].replaceAll(" ", ""),
		...
		if (Configurations.autoChisel)
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.autoChisel, 1), new Object[] { "XXX", "XYX", "XXX", Character.valueOf('X'), "plankWood", Character.valueOf('Y'),
					ModItems.chisel }));
		...
		if (Configurations.featureEnabled("pumpkin")) {
			for (int x = 0; x < 16; x++) {
				GameRegistry.addShapelessRecipe(new ItemStack(ModBlocks.jackolantern[x]),
						new Object[] { new ItemStack(ModBlocks.pumpkin[x], 1), new ItemStack(Item.getItemFromBlock(Blocks.torch), 1) });
			}
		}

		if (Configurations.featureEnabled("technical")) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.technical, Configurations.factoryBlockAmount, 0), new Object[] { "xyx", "yxy", "xyx", 'x', "stone", 'y',
					Items.iron_ingot }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.technical2, Configurations.factoryBlockAmount, 0), new Object[] { "xyx", "yzy", "xyx", 'x', "stone", 'y', "ingotIron",
					'z', Blocks.glass }));
		}
