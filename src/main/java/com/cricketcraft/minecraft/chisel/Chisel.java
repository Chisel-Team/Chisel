package com.cricketcraft.minecraft.chisel;
...
import com.cricketcraft.minecraft.chisel.client.gui.GuiAutoChisel;
import com.cricketcraft.minecraft.chisel.client.gui.GuiChisel;
import com.cricketcraft.minecraft.chisel.client.gui.GuiPresent;
import com.cricketcraft.minecraft.chisel.compat.Compatibility;
import com.cricketcraft.minecraft.chisel.compat.FMPIntegration;
import com.cricketcraft.minecraft.chisel.compat.ModIntegration;
...
import com.cricketcraft.minecraft.chisel.inventory.ContainerAutoChisel;
import com.cricketcraft.minecraft.chisel.inventory.ContainerChisel;
import com.cricketcraft.minecraft.chisel.inventory.ContainerPresent;
import com.cricketcraft.minecraft.chisel.inventory.InventoryChiselSelection;
import com.cricketcraft.minecraft.chisel.proxy.CommonProxy;
import com.cricketcraft.minecraft.chisel.utils.General;
import com.cricketcraft.minecraft.chisel.world.GeneratorLimestone;
import com.cricketcraft.minecraft.chisel.world.GeneratorMarble;
...
@Mod(modid = Chisel.MOD_ID, name = Chisel.MOD_NAME, version = Chisel.VERSION, guiFactory = "com.cricketcraft.minecraft.chisel.client.gui.GuiFactory",  dependencies = "after:ForgeMultipart;")
public class Chisel
{
    public static final String MOD_ID = "chisel";
    public static final BlockCarvable.SoundType soundTempleFootstep = new com.cricketcraft.minecraft.chisel.block.BlockCarvable.SoundType("dig.stone", MOD_ID + ":step.templeblock", 1.0f, 1.0f);
    ...
    @SidedProxy(clientSide = "com.cricketcraft.minecraft.chisel.proxy.ClientProxy", serverSide = "com.cricketcraft.minecraft.chisel.proxy.CommonProxy")
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        FMLInterModComms.sendMessage("Waila", "register", "com.cricketcraft.minecraft.chisel.Waila.register");
    }
