...
public class ChiselBlocks
{
    ...
    public static void load()
    {
        ...
        if(Chisel.featureEnabled("emeraldBlock"))
        {
            ...
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 2, "emerald/a1-blockemerald-emeraldpanelclassic");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 3, "emerald/a1-blockemerald-emeraldsmooth");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 4, "emerald/a1-blockemerald-emeraldchunk");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 5, "emerald/a1-blockemerald-emeraldornatelayer");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 6, "emerald/a1-blockemerald-emeraldzelda");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 7, "emerald/a1-blockquartz-cell");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 8, "emerald/a1-blockquartz-cellbismuth");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 9, "emerald/a1-blockquartz-four");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 10, "emerald/a1-blockquartz-fourornate");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 11, "emerald/a1-blockquartz-ornate");
