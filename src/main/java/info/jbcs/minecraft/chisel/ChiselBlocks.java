...
public class ChiselBlocks
{
    ...
    public static void load()
    {
        ...
        if(Chisel.featureEnabled("ironBlock"))
        {
            ...
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.1.desc"), 1, "iron/terrain-iron-largeingot");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.2.desc"), 2, "iron/terrain-iron-smallingot");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.3.desc"), 3, "iron/terrain-iron-gears");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.4.desc"), 4, "iron/terrain-iron-brick");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.5.desc"), 5, "iron/terrain-iron-plates");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.6.desc"), 6, "iron/terrain-iron-rivets");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.7.desc"), 7, "iron/terrain-iron-coin-heads");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.8.desc"), 8, "iron/terrain-iron-coin-tails");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.9.desc"), 9, "iron/terrain-iron-crate-dark");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.10.desc"), 10, "iron/terrain-iron-crate-light");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.11.desc"), 11, "iron/terrain-iron-moon");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.12.desc"), 12, "iron/terrain-iron-space");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.13.desc"), 13, "iron/terrain-iron-spaceblack");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.14.desc"), 14, "iron/terrain-iron-vents");
            blockIron.carverHelper.addVariation(I18n.format("chisel.tile.iron.15.desc"), 15, "iron/terrain-iron-simple");
        ...
        if(Chisel.featureEnabled("goldBlock"))
        {
            ...
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.1.desc"), 1, "gold/terrain-gold-largeingot");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.2.desc"), 2, "gold/terrain-gold-smallingot");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.3.desc"), 3, "gold/terrain-gold-brick");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.4.desc"), 4, "gold/terrain-gold-cart");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.5.desc"), 5, "gold/terrain-gold-coin-heads");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.6.desc"), 6, "gold/terrain-gold-coin-tails");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.7.desc"), 7, "gold/terrain-gold-crate-dark");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.8.desc"), 8, "gold/terrain-gold-crate-light");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.9.desc"), 9, "gold/terrain-gold-plates");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.10.desc"), 10, "gold/terrain-gold-rivets");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.11.desc"), 11, "gold/terrain-gold-star");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.12.desc"), 12, "gold/terrain-gold-space");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.13.desc"), 13, "gold/terrain-gold-spaceblack");
            blockGold.carverHelper.addVariation(I18n.format("chisel.tile.gold.14.desc"), 14, "gold/terrain-gold-simple");
        ...
        if(Chisel.featureEnabled("diamondBlock"))
        {
            ...
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.1.desc"), 1, "diamond/terrain-diamond-embossed");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.2.desc"), 2, "diamond/terrain-diamond-gem");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.3.desc"), 3, "diamond/terrain-diamond-cells");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.4.desc"), 4, "diamond/terrain-diamond-space");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.5.desc"), 5, "diamond/terrain-diamond-spaceblack");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.6.desc"), 6, "diamond/terrain-diamond-simple");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.7.desc"), 7, "diamond/a1-blockdiamond-bismuth");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.8.desc"), 8, "diamond/a1-blockdiamond-crushed");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.9.desc"), 9, "diamond/a1-blockdiamond-four");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.10.desc"), 10, "diamond/a1-blockdiamond-fourornate");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.11.desc"), 11, "diamond/a1-blockdiamond-zelda");
            blockDiamond.carverHelper.addVariation(I18n.format("chisel.tile.diamond.12.desc"), 12, "diamond/a1-blockdiamond-ornatelayer");
        ...
        if(Chisel.featureEnabled("glowstone"))
        {
            ...
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.1.desc"), 1, "lightstone/terrain-sulphur-cobble");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.2.desc"), 2, "lightstone/terrain-sulphur-corroded");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.3.desc"), 3, "lightstone/terrain-sulphur-glass");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.4.desc"), 4, "lightstone/terrain-sulphur-neon");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.5.desc"), 5, "lightstone/terrain-sulphur-ornate");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.6.desc"), 6, "lightstone/terrain-sulphur-rocky");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.7.desc"), 7, "lightstone/terrain-sulphur-shale");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.8.desc"), 8, "lightstone/terrain-sulphur-tile");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.9.desc"), 9, "lightstone/terrain-sulphur-weavelanternlight");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.10.desc"), 10, "lightstone/a1-glowstone-cobble");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.11.desc"), 11, "lightstone/a1-glowstone-growth");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.12.desc"), 12, "lightstone/a1-glowstone-layers");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.13.desc"), 13, "lightstone/a1-glowstone-tilecorroded");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.14.desc"), 14, "lightstone/glowstone-bismuth");
            blockLightstone.carverHelper.addVariation(I18n.format("chisel.tile.lightstone.15.desc"), 15, "lightstone/glowstone-bismuth-panel");
        ...
        if(Chisel.featureEnabled("lapisBlock"))
        {
            ...
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.1.desc"), 1, "lapis/terrain-lapisblock-chunky");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.2.desc"), 2, "lapis/terrain-lapisblock-panel");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.3.desc"), 3, "lapis/terrain-lapisblock-zelda");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.4.desc"), 4, "lapis/terrain-lapisornate");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.5.desc"), 5, "lapis/terrain-lapistile");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.6.desc"), 6, "lapis/a1-blocklapis-panel");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.7.desc"), 7, "lapis/a1-blocklapis-smooth");
            blockLapis.carverHelper.addVariation(I18n.format("chisel.tile.lapis.8.desc"), 8, "lapis/a1-blocklapis-ornatelayer");
        ...
        if(Chisel.featureEnabled("emeraldBlock"))
        {
            ...
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.1.desc"), 1, "emerald/a1-blockemerald-emeraldpanel");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.2.desc"), 2, "emerald/a1-blockemerald-emeraldpanelclassic");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.3.desc"), 3, "emerald/a1-blockemerald-emeraldsmooth");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.4.desc"), 4, "emerald/a1-blockemerald-emeraldchunk");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.5.desc"), 5, "emerald/a1-blockemerald-emeraldornatelayer");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.6.desc"), 6, "emerald/a1-blockemerald-emeraldzelda");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.7.desc"), 7, "emerald/a1-blockquartz-cell");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.8.desc"), 8, "emerald/a1-blockquartz-cellbismuth");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.9.desc"), 9, "emerald/a1-blockquartz-four");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.10.desc"), 10, "emerald/a1-blockquartz-fourornate");
            blockEmerald.carverHelper.addVariation(I18n.format("chisel.tile.emerald.11.desc"), 11, "emerald/a1-blockquartz-ornate");
        ...
        if(Chisel.featureEnabled("netherBrick"))
        {
            ...
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.1.desc"), 1, "netherbrick/a1-netherbrick-brinstar");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.2.desc"), 2, "netherbrick/a1-netherbrick-classicspatter");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.3.desc"), 3, "netherbrick/a1-netherbrick-guts");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.4.desc"), 4, "netherbrick/a1-netherbrick-gutsdark");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.5.desc"), 5, "netherbrick/a1-netherbrick-gutssmall");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.6.desc"), 6, "netherbrick/a1-netherbrick-lavabrinstar");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.7.desc"), 7, "netherbrick/a1-netherbrick-lavabrown");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.8.desc"), 8, "netherbrick/a1-netherbrick-lavaobsidian");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.9.desc"), 9, "netherbrick/a1-netherbrick-lavastonedark");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.10.desc"), 10, "netherbrick/a1-netherbrick-meat");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.11.desc"), 11, "netherbrick/a1-netherbrick-meatred");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.12.desc"), 12, "netherbrick/a1-netherbrick-meatredsmall");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.13.desc"), 13, "netherbrick/a1-netherbrick-meatsmall");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.14.desc"), 14, "netherbrick/a1-netherbrick-red");
            blockNetherBrick.carverHelper.addVariation(I18n.format("chisel.tile.netherBrick.15.desc"), 15, "netherbrick/a1-netherbrick-redsmall");
        ...
        if(Chisel.featureEnabled("netherRack"))
        {
            ...
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.1.desc"), 1, "netherrack/a1-netherrack-bloodgravel");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.2.desc"), 2, "netherrack/a1-netherrack-bloodrock");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.3.desc"), 3, "netherrack/a1-netherrack-bloodrockgrey");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.4.desc"), 4, "netherrack/a1-netherrack-brinstar");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.5.desc"), 5, "netherrack/a1-netherrack-brinstarshale");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.6.desc"), 6, "netherrack/a1-netherrack-classic");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.7.desc"), 7, "netherrack/a1-netherrack-classicspatter");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.8.desc"), 8, "netherrack/a1-netherrack-guts");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.9.desc"), 9, "netherrack/a1-netherrack-gutsdark");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.10.desc"), 10, "netherrack/a1-netherrack-meat");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.11.desc"), 11, "netherrack/a1-netherrack-meatred");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.12.desc"), 12, "netherrack/a1-netherrack-meatrock");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.13.desc"), 13, "netherrack/a1-netherrack-red");
            blockNetherrack.carverHelper.addVariation(I18n.format("chisel.tile.hellrock.14.desc"), 14, "netherrack/a1-netherrack-wells");
        ...
        if(Chisel.featureEnabled("cobblestoneMossy"))
        {
            ...
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.1.desc"), 1, "cobblestonemossy/terrain-cobb-brickaligned");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.2.desc"), 2, "cobblestonemossy/terrain-cob-detailedbrick");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.3.desc"), 3, "cobblestonemossy/terrain-cob-smallbrick");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.4.desc"), 4, "cobblestonemossy/terrain-cobblargetiledark");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.5.desc"), 5, "cobblestonemossy/terrain-cobbsmalltile");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.6.desc"), 6, "cobblestonemossy/terrain-cob-french");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.7.desc"), 7, "cobblestonemossy/terrain-cob-french2");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.8.desc"), 8, "cobblestonemossy/terrain-cobmoss-creepdungeon");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.9.desc"), 9, "cobblestonemossy/terrain-mossysmalltiledark");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.10.desc"), 10, "cobblestonemossy/terrain-pistonback-dungeontile");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.11.desc"), 11, "cobblestonemossy/terrain-pistonback-darkcreeper");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.12.desc"), 12, "cobblestonemossy/terrain-pistonback-darkdent");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.13.desc"), 13, "cobblestonemossy/terrain-pistonback-darkemboss");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.14.desc"), 14, "cobblestonemossy/terrain-pistonback-darkmarker");
            blockCobblestoneMossy.carverHelper.addVariation(I18n.format("chisel.tile.stoneMoss.15.desc"), 15, "cobblestonemossy/terrain-pistonback-darkpanel");
        ...
        if(Chisel.featureEnabled("stoneBrick"))
        {
            ...
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.4.desc"), 4, "stonebrick/smallbricks");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.5.desc"), 5, "stonebrick/largebricks");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.6.desc"), 6, "stonebrick/smallchaotic");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.7.desc"), 7, "stonebrick/chaoticbricks");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.8.desc"), 8, "stonebrick/chaotic");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.9.desc"), 9, "stonebrick/fancy");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.10.desc"), 10, "stonebrick/ornate");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.11.desc"), 11, "stonebrick/largeornate");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.12.desc"), 12, "stonebrick/panel-hard");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.13.desc"), 13, "stonebrick/sunken");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.14.desc"), 14, "stonebrick/ornatepanel");
            stoneBrick.carverHelper.addVariation(I18n.format("chisel.tile.stoneBrick.15.desc"), 15, "stonebrick/poison");
        ...
        if(Chisel.featureEnabled("dirt"))
        {
            ...
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.0.desc"), 0, "dirt/bricks");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.1.desc"), 1, "dirt/netherbricks");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.2.desc"), 2, "dirt/bricks3");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.3.desc"), 3, "dirt/cobble");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.4.desc"), 4, "dirt/reinforced");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.5.desc"), 5, "dirt/dirt-reinforced");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.6.desc"), 6, "dirt/happy");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.7.desc"), 7, "dirt/bricks2");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.8.desc"), 8, "dirt/bricks+dirt2");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.9.desc"), 9, "dirt/hor");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.10.desc"), 10, "dirt/vert");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.11.desc"), 11, "dirt/layers");
            blockDirt.carverHelper.addVariation(I18n.format("chisel.tile.blockDirt.12.desc"), 12, "dirt/vertical");
        ...
        if(Chisel.featureEnabled("ice"))
        {
            ...
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.1.desc"), 1, "ice/a1-ice-light");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.2.desc"), 2, "ice/a1-stonecobble-icecobble");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.3.desc"), 3, "ice/a1-netherbrick-ice");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.4.desc"), 4, "ice/a1-stonecobble-icebrick");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.5.desc"), 5, "ice/a1-stonecobble-icebricksmall");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.6.desc"), 6, "ice/a1-stonecobble-icedungeon");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.7.desc"), 7, "ice/a1-stonecobble-icefour");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.8.desc"), 8, "ice/a1-stonecobble-icefrench");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.9.desc"), 9, "ice/sunkentiles");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.10.desc"), 10, "ice/tiles");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.11.desc"), 11, "ice/a1-stonecobble-icepanel");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.12.desc"), 12, "ice/a1-stoneslab-ice");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.13.desc"), 13, "ice/zelda");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.14.desc"), 14, "ice/bismuth");
            blockIce.carverHelper.addVariation(I18n.format("chisel.tile.ice.15.desc"), 15, "ice/poison");
