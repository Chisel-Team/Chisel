...
@Mod(modid = Chisel.MOD_ID, name = Chisel.MOD_NAME, version = "2.0", guiFactory = "info.jbcs.minecraft.chisel.client.gui.GuiFactory",  dependencies = "after:ForgeMultipart;")
public class Chisel
{
