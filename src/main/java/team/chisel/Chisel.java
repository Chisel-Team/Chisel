...
//        MinecraftForge.EVENT_BUS.register(PerChunkData.INSTANCE);
        ...
        for (Biome b : ForgeRegistries.BIOMES.getValues()) {
            if (BiomeDictionary.hasType(b, BiomeDictionary.Type.OVERWORLD)) {
                ...
                b.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Features.BASALT.get(VariantTemplates.Rock.RAW.getName()).get().getDefaultState(), 33), Placement.COUNT_RANGE, new CountRangeConfig(10, 0, 0, 32)));
                // TODO marble gen
                // TODO limestone gen
            }
        }
