...
@Mod(modid = Reference.MOD_ID, version = Reference.VERSION, name = Reference.MOD_NAME, dependencies = "required-after:forge@[14.23.0.2501,);required-after-client:ctm", acceptedMinecraftVersions = "[1.12.2, 1.13)")
