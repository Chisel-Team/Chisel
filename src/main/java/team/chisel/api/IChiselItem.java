...
public interface IChiselItem {
     ...
     * @param player {@link Player The player} holding the chisel.
     * @param hand   The {@link InteractionHand} which the chisel is in. Use this and the {@code player} parameter to get stack context.
     * @param pos    The {@link BlockPos position} of the block being chiseled.
     * @param state  The {@link BlockState} of the block being chiseled.
     ...
     *
     * @param player {@link Player The player} holding the chisel.
     * @param chisel The {@link ItemStack} of the current chisel.
     * @param mode   The current {@link IChiselMode}.
     ...
     *
     * @param chisel  The {@link ItemStack} being used as a chisel.
     * @param source  The source {@link ItemStack}. This is the stack of items that is being chiseled into something else. This must be modified by this function. i.e. if the chisel has only 1 damage
     *                left, the source stack size should be decremented by 1.
     * @param target  The target stack, the type of which the source stack is being chiseled into. Do NOT modify this stack, instead return the result of the craft.
     * @param player  The player doing the chiseling.
     * @param onBreak A callback to perform when the chisel breaks.
