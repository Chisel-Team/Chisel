...
public class Features {
    ...
    public static final Map<String, RegistryEntry<BlockCarvable>> ANTIBLOCK = FACTORY.newType(Material.ROCK, "antiblock", (p, v) -> new BlockCarvable(p, v, BlockRenderLayer.CUTOUT))
