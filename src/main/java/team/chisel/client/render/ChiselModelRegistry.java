...
public enum ChiselModelRegistry implements Reference {
    ...
    public void onModelBake(ModelBakeEvent event) throws IOException {
        ...
        baseModel = model.bake(new TRSRTransformation(ModelRotation.X0_Y90), Attributes.DEFAULT_BAKED_FORMAT, r -> Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(r.toString()));
